...
const ROOMS_PATH = window.firestoreConfig.roomBath ?? 'chatRooms'
const MESSAGES_PATH = 'messages'
const MESSAGE_PATH = roomId => {
    return `${ROOMS_PATH}/${roomId}/${MESSAGES_PATH}`
}
const USERS_DATA_PATH = roomId => {
    return `${ROOMS_PATH}/${roomId}/${USERS_PATH}`
}
const USER_DATA_PATH = (roomId, userId) => {
    return `${ROOMS_PATH}/${roomId}/${USERS_PATH}/${userId}`
}
...
const userDataRef = roomId => {
    return collection(firestoreDb, USERS_DATA_PATH(roomId))
}
...
export const getUserData = (roomId, userId) => {
    return getDocument(doc(firestoreDb, USER_DATA_PATH(roomId, userId)))
}

export const getAllUsersData = (roomId) => {
    return getDocuments(query(userDataRef(roomId)))
}
...
export const addUserData = (roomId, userId, data) => {
    return setDocument(USERS_DATA_PATH(roomId), userId, data)
}
