        ...
        <div class="getting-started-example-styled">
            <div class="getting-started-example-styled__content">
                ...
                <div class="alert-icon">
                    <Icon icon="emojione-v1:warning" width="6em" height="6em"/>
                    <!--<img src="/panel/images/icons/warning.svg"/>-->
                </div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.$bus.on('confirmation-dialog', (value, config = {}) => {
                this.loading = false;
        ...
        computed: {
            title$() {
                return this.title ?? this.trans('sure_to_delete');
            },
            message$() {
