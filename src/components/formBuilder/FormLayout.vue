        ...
        <div class="form-outer">
            <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                <div class="form-header-inner">
                    ...
                    <div class="right">
                        <slot name="actions" :isSubmitting="loading" :isLoading="isLoading" :isEdit="isEdit"
                              :model="form" :onCancel="onCancel">
                            <div class="buttons">
            ...
            <VLoader size="small" :active="isLoading" class="loading-overlay">
                <div class="form-body form-separator">
                    ...
                    <Fieldset v-for="fieldset in fieldSets$" v-bind="fieldset" :loading="find_loading"
