    ...
    export default {
        ...
        methods: {
            ...
            setPlace(place) {
                ...
                if (this.mode === "marker")
                    this.setPlaceMarker(GEOPoint);
                else
                    this.setAreaPolygon(place.name, GEOPoint);
            ...
            setCenterPoint(GEOPoint = null) {
                if (this.checkPointIsValid(GEOPoint))
                    _.set(this, 'center$', GEOPoint);
            ...
            addMarker(GEOPoint = null) {
                this.markers.push({position: this.checkPointIsValid(GEOPoint) ? GEOPoint : this.center$});
                this.$nextTick(() => {
                    this.touch();
                })
            },
        ...
        computed: {
            ...
            committedInput() {
                ...
                switch (this.mode) {
                    case "marker" :
                        return this.multiple ? this._markers : _.get(this, '_markers.0', null);
                    case "polygon" :
                        return this.multiple ? this.polygons : _.get(this, 'polygons.0', null);
                }
            },
        ...
        watch: {
            ...
            inputValue: {
                ...
                immediate: true,
                handler(newVal) {
                    if (!newVal || this.updated)
                        return;

                    switch (true) {
                        case this.mode === "marker" && this.multiple :
                            _.set(this, 'markers', _.map(JSON.parse(JSON.stringify(newVal)), (marker) => {
                                return {
                                    position: marker
                                };
                            }));
                        ...
                        case this.mode === "polygon" && this.multiple :
                            this.polygons = newVal instanceof Array && newVal[0] instanceof Array ? newVal : [];
