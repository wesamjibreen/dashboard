            ...
            >
              <template #icon>
                <!--<tippy-->
                  ...
                  <!--placement="top-start"-->
                <!--&gt;-->
                  <!--<VAvatar size="medium" picture="/images/avatars/31.jpg" />-->
                  <!--<template #content>-->
                    <!--&lt;!&ndash;<UserPopoverContent :user="popovers.user31" />&ndash;&gt;-->
                  <!--</template>-->
                <!--</tippy>-->
              </template>
              <template #action>
            ...
            >
              <template #icon>
                <!--<tippy-->
                  ...
                  <!--placement="top-start"-->
                <!--&gt;-->
                  <!--<VAvatar size="medium" picture="/images/avatars/23.jpg" />-->
                  <!--<template #content>-->
            ...
            >
              <template #icon>
                <!--<tippy-->
                  ...
                  <!--placement="top-start"-->
                <!--&gt;-->
                  <!--<VAvatar size="medium" picture="/images/avatars/32.jpg" />-->
                  <!--<template #content>-->
