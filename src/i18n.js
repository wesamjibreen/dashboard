...
export const common = {
    ar: {
        ...
        sure_to_cancel: "هل أنت متأكد من إلغاء العملية ؟",
        cancel_operation : "إلغاء العملية" ,
        empty_text : "لا توجد مهام جديدة للموافقة عليها في الوقت الحالي.",
    ...
    en: {
        ...
        empty_text : "There are no new tasks to approve for now.",
        sure_to_delete: "Are you sure to delete?",
        sure_to_cancel: "Are you sure to cancel operation ?",
        confirm: "Confirm",
        email: "E-mail",
        password: "Password",
